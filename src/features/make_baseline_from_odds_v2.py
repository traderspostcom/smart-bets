...
from .live import router as live_router  # mounts /picks_live and /admin/peek_csv
...
def refresh_firsthalf(
    ...
    # unchanged for now (we’ll update to v2 after full-game is green)
